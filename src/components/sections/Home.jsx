...
const content = {
    ...
    callForPapers: {
        ...
        categories: [
            ...
            { title: "Applications & Ethics", icon: <Users className="w-7 h-7 text-brand-accent" />, items: ["Healthcare & Accessibility: deployment of SLR systems in clinical, telemedicine, and assistive contexts.", "Ethical Considerations: community-involved research, data governance, and algorithmic fairness."] }
        ],
